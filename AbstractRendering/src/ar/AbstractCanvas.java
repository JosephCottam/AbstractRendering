...
public class AbstractCanvas {
	public static <A> Aggregates<A> render(final GlyphSet glyphs, final AffineTransform inverseView, 
	...
	public static  <A> BufferedImage render(Aggregates<A> aggregates, Transfer<A> t) {
