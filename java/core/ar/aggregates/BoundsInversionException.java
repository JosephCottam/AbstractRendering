...
public final class BoundsInversionException extends RuntimeException {
	...
	public BoundsInversionException(int low, int high, String dim) {
		super(String.format("Inverted bounds: low%1$s (%2$d) must be lower than high%1$s (%3$d)", dim,low,high));
	}
}