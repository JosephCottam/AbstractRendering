...
public abstract class NanoHTTPD {
    ...
    protected class HTTPSession {
        ...
        public void execute() throws IOException {
            try {
                ...
                rlen = 0;
                {
                    ...
                    if(read == -1){
                        // socket was closed
                        throw new SocketException();  //TODO: Should silent return instead?
                    }
                    while (read > 0) {
                        rlen += read;
        ...
        /**
         * Decodes parameters in percent-encoded URI-format ( e.g. "name=Jack%20Daniels&test=Single%20Malt" ) and
    ...
    private static final class ResponseException extends Exception {
		private static final long serialVersionUID = -8420038123410139269L;
